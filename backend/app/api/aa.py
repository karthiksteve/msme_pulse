...
router = APIRouter(prefix="", tags=["Account Aggregator"])


@router.post("/accounts", response_model=AAAccountResponse, status_code=201)
...
@router.get("/msme/{msme_id}/accounts", response_model=List[AAAccountResponse])
...
@router.get("/accounts/{account_id}", response_model=AAAccountResponse)
